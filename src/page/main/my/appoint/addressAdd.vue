    ...
    <div id='main' ref='main'>
        <div class='list_box'>
            ...
            <div class='list wm_margin list_zone' @click='zoneObj.isShow=!zoneObj.isShow'>
                ...
                <span :class='["list_con_zone",{"color_gray":zoneObj.selectText=="请填写省、市、地区"}]'>{{zoneObj.selectText}}</span>
        ...
        <div class='btn'>
            <span @click='save' class='wm_bgcolor_main'>保存</span>
        </div>
...
<script type='text/javascript'>
    ...
    export default {
        ...
        mounted() {
            this.$wm_data.setHeader({title: '新增地址'})
        ...
        methods: {
            ...
            */
            save() {
                ...
                this.$axios.post(common_request+'v1/address/apend', {
                    token: getLocalToken(),
