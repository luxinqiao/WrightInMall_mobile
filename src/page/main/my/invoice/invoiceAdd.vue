...
<script type='text/javascript'>
    ...
    export default {
        data() {
            return {
                name: '',
                headType: Dict_InvoiceHead.PERSON,
                taxNumber: '',
                invoiceHead: Dict_InvoiceHead
            }
        },
        mounted() {
            this.$wm_data.setHeader({title: '新增发票抬头'})
        ...
        methods: {
            ...
            */
            save() {
                ...
                this.$axios.post(common_request + 'v1/inv/apend', {
                    token: getLocalToken(),
                    name: this.name,
                    style: this.headType,
                    tax_number: this.taxNumber,
                    inv_record_style: Dict_InvoiceType.COMMON
                }).then(response => {
